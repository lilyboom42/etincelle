 ...
 */
final class Version20241110184622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD service_id INT NOT NULL, DROP service_type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD service_type VARCHAR(80) NOT NULL, DROP service_id');
    }
}
